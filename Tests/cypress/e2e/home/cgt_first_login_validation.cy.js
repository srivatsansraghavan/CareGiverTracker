...
it('verify whether first time user modal dialog is displayed when Sign me up! button is clicked, and Add Role by clicking Save button', { defaultCommandTimeout: 5000 }, () => {
  ...
  it('Sign up as another user, click Later button in First time user modal, then Login and Add Role', { defaultCommandTimeout: 5000 },  () => {
