...
router.post("/save-tracking-feed", async (req, res) => {
  try {
...
router.post("/save-pumping-feed", async (req, res) => {
  try {
    const collection = await dbConfig.connectToMongoDBGetTable(
      dbConfig.cgtdbEnv[process.env.NODE_ENV],
      "tbl_feeding"
...
router.get("/get-feed-details", async (req, res) => {
  try {
    const collection = await dbConfig.connectToMongoDBGetTable(
      dbConfig.cgtdbEnv[process.env.NODE_ENV],
      "tbl_feeding"
...
router.get("/get-pumped-feeds", async (req, res) => {
  try {
    const collection = await dbConfig.connectToMongoDBGetTable(
      dbConfig.cgtdbEnv[process.env.NODE_ENV],
      "tbl_feeding"
...
router.delete("/delete-feed/:feedId", async (req, res) => {
  try {
    const collection = await dbConfig.connectToMongoDBGetTable(
      dbConfig.cgtdbEnv[process.env.NODE_ENV],
      "tbl_feeding"
...
router.get("/get-feed-for-id/:feedId", async (req, res) => {
  try {
    const collection = await dbConfig.connectToMongoDBGetTable(
      dbConfig.cgtdbEnv[process.env.NODE_ENV],
      "tbl_feeding"
...
router.post("/save-edited-feed", async (req, res) => {
  try {
    const collection = await dbConfig.connectToMongoDBGetTable(
      dbConfig.cgtdbEnv[process.env.NODE_ENV],
      "tbl_feeding"
